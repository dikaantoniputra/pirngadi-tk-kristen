    ...
    <div class="container">
       ...
       <div class="row">
          <div class="col-lg-4 text-center">
             <!-- logo -->
             <img src="{{ asset('img/logo-pirngadi.png') }}" alt="" class="img-fluid">
             <h5 class="mt-3">TK KRISTEN PIRNGADI</h5>
             <!-- Mailist Form -->				
       ...
       <div class="row">
          <div class="credits col-sm-12">
             <p>Copyright 2024 / Designed by <a href="http://www.ingridkuhn.com">PIRNGADI</a></p>
          </div>
       </div>
       <!--/row-->
    </div>
